...
// Todo Items for Day 4
// display an "no items found" message to the user if no todos in the array
// add functionality to hit enter after input todo and then focus back on input
