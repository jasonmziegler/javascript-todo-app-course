...
// Add search
// add an input to the HTML
// we want search and filterMethod in data to work together 
// filter then search 
// View 
// need to target the DOM
// Controller
// create view dom variables
// Handle the Search - create search function 
// add an event listener to the dom
// // on change so see in real time
